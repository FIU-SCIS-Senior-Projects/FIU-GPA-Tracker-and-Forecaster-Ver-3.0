...
.md-ripple.md-ripple-placed {
    transition: margin 0.9s cubic-bezier(0.25, 0.8, 0.25, 1) 0s, border 0.9s cubic-bezier(0.25, 0.8, 0.25, 1) 0s, width 0.9s cubic-bezier(0.25, 0.8, 0.25, 1) 0s, height 0.9s cubic-bezier(0.25, 0.8, 0.25, 1) 0s, opacity 0.9s cubic-bezier(0.25, 0.8, 0.25, 1) 0s, transform 0.9s cubic-bezier(0.25, 0.8, 0.25, 1) 0s;
}
...
.md-button.md-fab.md-focused:not([disabled]), .md-button.md-raised.md-focused:not([disabled]) {
    box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.26);
}
.md-button.md-fab:active:not([disabled]), .md-button.md-raised:active:not([disabled]) {
    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4);
}
...
.md-toast-open-top .md-button.md-fab-top-left.md-focused:not([disabled]), .md-toast-open-top .md-button.md-fab-top-left:hover:not([disabled]), .md-toast-open-top .md-button.md-fab-top-right.md-focused:not([disabled]), .md-toast-open-top .md-button.md-fab-top-right:hover:not([disabled]) {
...
.md-toast-open-bottom .md-button.md-fab-bottom-left.md-focused:not([disabled]), .md-toast-open-bottom .md-button.md-fab-bottom-left:hover:not([disabled]), .md-toast-open-bottom .md-button.md-fab-bottom-right.md-focused:not([disabled]), .md-toast-open-bottom .md-button.md-fab-bottom-right:hover:not([disabled]) {
...
md-card .md-actions.layout-column .md-button:first-of-type:not(.md-icon-button), md-card md-card-actions.layout-column .md-button:first-of-type:not(.md-icon-button) {
    margin-top: 0;
}
md-card .md-actions.layout-column .md-button:last-of-type:not(.md-icon-button), md-card md-card-actions.layout-column .md-button:last-of-type:not(.md-icon-button) {
    margin-bottom: 0;
}
...
md-card .md-actions:not(.layout-column) .md-button:first-of-type:not(.md-icon-button), md-card md-card-actions:not(.layout-column) .md-button:first-of-type:not(.md-icon-button) {
    margin-left: 0;
}
md-card .md-actions:not(.layout-column) .md-button:last-of-type:not(.md-icon-button), md-card md-card-actions:not(.layout-column) .md-button:last-of-type:not(.md-icon-button) {
    margin-right: 0;
}
...
.md-chips .md-chip-input-container input:focus:not([type]), .md-chips .md-chip-input-container input[type="url"]:focus, .md-chips .md-chip-input-container input[type="text"]:focus, .md-chips .md-chip-input-container input[type="email"]:focus, .md-chips .md-chip-input-container input[type="number"]:focus, .md-chips .md-chip-input-container input[type="tel"]:focus {
    outline: 0 none;
}
...
.md-calendar-date-selection-indicator {
    ...
    height: 40px;
    line-height: 40px;
    transition: background-color 0s ease 0s, color 0.4s cubic-bezier(0.25, 0.8, 0.25, 1) 0s;
    width: 40px;
}
...
.md-datepicker-calendar-pane {
    ...
    transition: transform 0.2s cubic-bezier(0.25, 0.8, 0.25, 1) 0s;
    z-index: 100;
}
...
.md-datepicker-calendar {
    opacity: 0;
    transition: opacity 0.2s cubic-bezier(0.5, 0, 0.25, 1) 0s;
}
...
.md-datepicker-calendar-pane .md-calendar {
    ...
    transition: transform 0.65s cubic-bezier(0.25, 0.8, 0.25, 1) 0.125s;
}
...
md-fab-speed-dial:not(.md-hover-full) .md-fab-action-item, md-fab-speed-dial:not(.md-hover-full) md-fab-trigger, md-fab-speed-dial.md-is-open:not(.md-hover-full) {
    pointer-events: auto;
}
...
md-fab-speed-dial.md-scale .md-fab-action-item {
    transform: scale(0);
    transition: all 0.14286s cubic-bezier(0.55, 0, 0.55, 0.2) 0s;
}
md-fab-toolbar {
    display: block;
}
...
md-fab-toolbar md-toolbar .md-fab-action-item {
    opacity: 0;
    transform: scale(0);
    transition: all 0.15s cubic-bezier(0.55, 0, 0.55, 0.2) 0s;
}
...
md-input-container .ng-enter[data-ng-messages] [data-ng-message-exp], md-input-container .ng-enter[data-ng-messages] [data-ng-message], md-input-container .ng-enter[data-ng-messages] [ng-message-exp], md-input-container .ng-enter[data-ng-messages] [ng-message], md-input-container .ng-enter[data-ng-messages] [x-ng-message-exp], md-input-container .ng-enter[data-ng-messages] [x-ng-message], md-input-container .ng-enter[data-ng-messages] data-ng-message, md-input-container .ng-enter[data-ng-messages] ng-message, md-input-container .ng-enter[data-ng-messages] x-ng-message, md-input-container .ng-enter[ng-messages] [data-ng-message-exp], md-input-container .ng-enter[ng-messages] [data-ng-message], md-input-container .ng-enter[ng-messages] [ng-message-exp], md-input-container .ng-enter[ng-messages] [ng-message], md-input-container .ng-enter[ng-messages] [x-ng-message-exp], md-input-container .ng-enter[ng-messages] [x-ng-message], md-input-container .ng-enter[ng-messages] data-ng-message, md-input-container .ng-enter[ng-messages] ng-message, md-input-container .ng-enter[ng-messages] x-ng-message, md-input-container .ng-enter[x-ng-messages] [data-ng-message-exp], md-input-container .ng-enter[x-ng-messages] [data-ng-message], md-input-container .ng-enter[x-ng-messages] [ng-message-exp], md-input-container .ng-enter[x-ng-messages] [ng-message], md-input-container .ng-enter[x-ng-messages] [x-ng-message-exp], md-input-container .ng-enter[x-ng-messages] [x-ng-message], md-input-container .ng-enter[x-ng-messages] data-ng-message, md-input-container .ng-enter[x-ng-messages] ng-message, md-input-container .ng-enter[x-ng-messages] x-ng-message, md-input-container data-ng-messages.ng-enter [data-ng-message-exp], md-input-container data-ng-messages.ng-enter [data-ng-message], md-input-container data-ng-messages.ng-enter [ng-message-exp], md-input-container data-ng-messages.ng-enter [ng-message], md-input-container data-ng-messages.ng-enter [x-ng-message-exp], md-input-container data-ng-messages.ng-enter [x-ng-message], md-input-container data-ng-messages.ng-enter data-ng-message, md-input-container data-ng-messages.ng-enter ng-message, md-input-container data-ng-messages.ng-enter x-ng-message, md-input-container ng-messages.ng-enter [data-ng-message-exp], md-input-container ng-messages.ng-enter [data-ng-message], md-input-container ng-messages.ng-enter [ng-message-exp], md-input-container ng-messages.ng-enter [ng-message], md-input-container ng-messages.ng-enter [x-ng-message-exp], md-input-container ng-messages.ng-enter [x-ng-message], md-input-container ng-messages.ng-enter data-ng-message, md-input-container ng-messages.ng-enter ng-message, md-input-container ng-messages.ng-enter x-ng-message, md-input-container x-ng-messages.ng-enter [data-ng-message-exp], md-input-container x-ng-messages.ng-enter [data-ng-message], md-input-container x-ng-messages.ng-enter [ng-message-exp], md-input-container x-ng-messages.ng-enter [ng-message], md-input-container x-ng-messages.ng-enter [x-ng-message-exp], md-input-container x-ng-messages.ng-enter [x-ng-message], md-input-container x-ng-messages.ng-enter data-ng-message, md-input-container x-ng-messages.ng-enter ng-message, md-input-container x-ng-messages.ng-enter x-ng-message {
    margin-top: -100px;
    opacity: 0;
}
...
.md-open-menu-container.md-leave {
    opacity: 0;
    transition: all 250ms cubic-bezier(0.55, 0, 0.55, 0.2) 0s;
}
md-menu-content {
    display: flex;
    flex-direction: column;
...
md-progress-circular .md-mode-indeterminate .md-spinner-wrapper {
    animation: 2.91667s linear 0s normal none infinite running outer-rotate;
}
md-progress-circular .md-mode-indeterminate .md-spinner-wrapper .md-inner {
    animation: 5.25s cubic-bezier(0.35, 0, 0.25, 1) 0s normal none infinite running sporadic-rotate;
}
...
md-progress-linear .md-container.md-mode-query .md-bar2 {
    animation: 0.8s cubic-bezier(0.39, 0.575, 0.565, 1) 0s normal none infinite running query;
...
md-progress-linear .md-container.md-mode-indeterminate .md-bar1 {
    animation: 4s ease 0s normal none infinite running md-progress-linear-indeterminate-scale-1, 4s ease 0s normal none infinite running md-progress-linear-indeterminate-1;
}
md-progress-linear .md-container.md-mode-indeterminate .md-bar2 {
    animation: 4s ease 0s normal none infinite running md-progress-linear-indeterminate-scale-2, 4s ease 0s normal none infinite running md-progress-linear-indeterminate-2;
}
...
md-progress-linear .md-container.md-mode-buffer .md-dashed::before {
    animation: 3s linear 0s normal none infinite running buffer;
    display: block;
}
@keyframes query {
0% {
...
.md-select-menu-container.md-active md-select-menu {
    transition: all 150ms cubic-bezier(0.25, 0.8, 0.25, 1) 0s;
}
.md-select-menu-container.md-active md-select-menu > * {
    opacity: 1;
    transition: all 150ms cubic-bezier(0.55, 0, 0.55, 0.2) 100ms;
}
...
md-select.ng-invalid.ng-dirty:not([disabled]) .md-select-value {
...
md-sidenav.md-locked-open-remove-active {
    min-width: 0;
    transition: width 0.3s cubic-bezier(0.55, 0, 0.55, 0.2) 0s, min-width 0.3s cubic-bezier(0.55, 0, 0.55, 0.2) 0s;
    width: 0;
}
...
md-slider .md-sign {
    ...
    position: absolute;
    top: -20px;
    transform: scale(0.4) translate3d(0px, 70px, 0px);
...
md-slider .md-focus-thumb {
    animation: 0.4s linear 0s normal none 1 running sliderFocusThumb;
...
md-slider:hover:not([md-discrete]):not([disabled]) .md-thumb {
    transform: scale(0.6);
}
md-slider.md-active:not([md-discrete]):not([disabled]) .md-focus-thumb, md-slider:focus:not([md-discrete]):not([disabled]) .md-focus-thumb {
    display: block;
}
md-slider.md-active:not([md-discrete]):not([disabled]) .md-focus-ring, md-slider:focus:not([md-discrete]):not([disabled]) .md-focus-ring {
    transform: scale(1);
}
md-slider.md-active:not([md-discrete]):not([disabled]) .md-thumb, md-slider:focus:not([md-discrete]):not([disabled]) .md-thumb {
    transform: scale(0.85);
}
md-slider[md-discrete] .md-focus-ring, md-slider[md-discrete] .md-focus-thumb {
    display: none;
}
md-slider.md-active[md-discrete]:not([disabled]) .md-sign, md-slider.md-active[md-discrete]:not([disabled]) .md-sign::after, md-slider[md-discrete]:focus:not([disabled]) .md-sign, md-slider[md-discrete]:focus:not([disabled]) .md-sign::after {
    opacity: 1;
...
.md-sticky-clone[sticky-state="active"]:not(.md-sticky-no-effect) .md-subheader-inner {
    animation: 0.3s ease-out 0s normal both 1 running subheaderStickyHoverIn;
}
...
.md-subheader-wrapper.md-sticky-clone:not(.md-sticky-no-effect) {
    z-index: 2;
}
.md-subheader-wrapper[sticky-state="active"]:not(.md-sticky-no-effect) {
    margin-top: -2px;
}
.md-subheader-wrapper[sticky-prev-state="active"]:not(.md-sticky-no-effect):not(.md-sticky-clone) .md-subheader-inner::after {
    animation: 0.3s ease-out 0s normal both 1 running subheaderStickyHoverOut;
}
.md-subheader {
    display: block;
    font-size: 14px;
...
md-tabs-wrapper md-next-button, md-tabs-wrapper md-prev-button {
    ...
    top: 50%;
    transform: translateY(-50%);
    transition: all 0.5s cubic-bezier(0.35, 0, 0.25, 1) 0s;
    width: 32px;
    z-index: 2;
}
...
md-pagination-wrapper {
    ...
    position: absolute;
    transform: translate3d(0px, 0px, 0px);
    transition: transform 0.5s cubic-bezier(0.35, 0, 0.25, 1) 0s;
    width: 999999px;
}
...
md-tab-content.md-left:not(.md-active) {
    animation: 1s ease 0s normal none 1 running md-tab-content-hide;
    opacity: 0;
...
md-ink-bar.md-left {
    transition: left 0.125s cubic-bezier(0.35, 0, 0.25, 1) 0s, right 0.25s cubic-bezier(0.35, 0, 0.25, 1) 0s;
}
md-ink-bar.md-right {
    transition: left 0.25s cubic-bezier(0.35, 0, 0.25, 1) 0s, right 0.125s cubic-bezier(0.35, 0, 0.25, 1) 0s;
}
md-tab {
    left: -9999px;
    position: absolute;
...
@media only screen and (min-width: 0px) and (max-width: 959px) and (orientation: portrait) {
md-toolbar {
    min-height: 56px;
}
.md-toolbar-tools {
